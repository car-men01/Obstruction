...
class UI:
    ...
    @staticmethod
    def get_computer_player_ai():
        return ComputerAIMoves()
    ...
    def start(self):
        ...
        difficulty = input("Choose the difficulty level (easy / hard): ")
        try:
            if difficulty == "easy":
                ...
                board_game = Board(board_size)
                computer_player_ai = self.get_computer_player_ai()
                game = Game(board_game, computer_player_ai)
            else:
